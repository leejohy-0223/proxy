...
public class JdkDynamicProxyTest {
    ...
    @Test
    void dynamicA() {
        AInterface target = new AImpl(); // 1
        TimeInvocationHandler handler = new TimeInvocationHandler(target); // 2
        // 3
        ...
        // 4
        proxy.call();
        log.info("class loader info = {}", AInterface.class.getClassLoader());
    ...
    void dynamicB() {
        ...
        proxy.call();
        log.info("class loader info = {}", BInterface.class.getClassLoader());
        log.info("targetClass = {}", target.getClass());
        log.info("proxyClass = {}", proxy.getClass());
    }
}
